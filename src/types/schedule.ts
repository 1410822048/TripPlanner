...
//
// Money domain: `estimatedCostMinor` is integer minor units per the
// money refactor. The form layer converts user-typed decimal strings
// via `parseMoneyToMinor`.
import { z } from 'zod'
...
export const CreateScheduleSchema = z.object({
  ...
  // Integer minor units; 1B cap mirrors expense.amountMinor. Above this
  // is corruption / typo, not a real cost estimate; rules layer also gates.
