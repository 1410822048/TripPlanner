// src/features/schedule/components/TripSwitcher.tsx
import { useState, useRef, useEffect } from 'react'
import { Plus, ChevronDown } from 'lucide-react'
import SwipeableTripItem from './SwipeableTripItem'
import { toast } from '@/shared/toast'
import type { TripItem, MenuActionKey } from '../types'
              ...
              >
                {trips.map(trip => (
                  <SwipeableTripItem
                    ...
                    onSelect={() => { onSelect(trip); setOpen(false); setSwipedId(null) }}
                    onOpen={() => setSwipedId(trip.id)}
                    onClose={() => { if (swipedId === trip.id) setSwipedId(null) }}
                    onDelete={() => { onDelete(trip.id); setSwipedId(null) }}
