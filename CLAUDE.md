...
This project is indexed by GitNexus as **TripPlanner** (5864 symbols, 14347 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
