...
This project is indexed by GitNexus as **TripPlanner** (5542 symbols, 13645 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
