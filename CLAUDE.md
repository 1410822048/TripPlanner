...
This project is indexed by GitNexus as **TripPlanner** (5794 symbols, 14166 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
