...
This project is indexed by GitNexus as **TripPlanner** (4117 symbols, 10385 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
