...
This project is indexed by GitNexus as **TripPlanner** (5591 symbols, 13758 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
