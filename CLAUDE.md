...
This project is indexed by GitNexus as **TripPlanner** (3985 symbols, 10118 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
