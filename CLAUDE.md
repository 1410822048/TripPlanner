...
This project is indexed by GitNexus as **TripPlanner** (4090 symbols, 10312 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
